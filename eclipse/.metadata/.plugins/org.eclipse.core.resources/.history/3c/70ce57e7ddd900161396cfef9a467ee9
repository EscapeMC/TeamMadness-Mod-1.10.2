...
import com.github.escapemc.teammadnessmod.container.ContainerBlackHole;
...
public class GuiBlackHole extends GuiContainer {
	...
	public GuiBlackHole(Container containerBlackHole, TileEntityBlackHole te) {
		super(containerBlackHole);
		this.te = te;
		TEST_BAG_GUI_TEXTURE = new ResourceLocation("tmm:textures/gui/container/black_hole.png");
		this.ySize = 266;
		this.xSize = 338;
	}
