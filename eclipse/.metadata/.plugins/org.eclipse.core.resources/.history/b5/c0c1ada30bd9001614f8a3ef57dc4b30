package com.github.escapemc.teammadnessmod.tileentity;
...
public class TileEntityMadnessFurnace extends TileEntityLockable implements ISidedInventory, ITickable {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.madness_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                madness_furnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
