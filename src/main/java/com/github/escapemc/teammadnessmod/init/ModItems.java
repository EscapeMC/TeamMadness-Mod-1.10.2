...
import com.github.escapemc.teammadnessmod.items.bossface88_armor;
import com.github.escapemc.teammadnessmod.items.bossface88_axe;
import com.github.escapemc.teammadnessmod.items.bossface88_hoe;
import com.github.escapemc.teammadnessmod.items.bossface88_ingot;
import com.github.escapemc.teammadnessmod.items.bossface88_pickaxe;
import com.github.escapemc.teammadnessmod.items.bossface88_shovel;
import com.github.escapemc.teammadnessmod.items.bossface88_sword;
...
import com.github.escapemc.teammadnessmod.items.diamondtips_armor;
import com.github.escapemc.teammadnessmod.items.diamondtips_axe;
import com.github.escapemc.teammadnessmod.items.diamondtips_hoe;
import com.github.escapemc.teammadnessmod.items.diamondtips_ingot;
import com.github.escapemc.teammadnessmod.items.diamondtips_pickaxe;
import com.github.escapemc.teammadnessmod.items.diamondtips_shovel;
import com.github.escapemc.teammadnessmod.items.diamondtips_sword;
...
import com.github.escapemc.teammadnessmod.items.ianplaysyt_hoe;
import com.github.escapemc.teammadnessmod.items.ianplaysyt_ingot;
...
import com.github.escapemc.teammadnessmod.items.midm;
...
public class ModItems {
	...
	public static Item ianplaysyt_axe;
	public static Item ianplaysyt_shovel;
	public static Item ianplaysyt_hoe;
	public static Item ianplaysyt_helmet;
	public static Item ianplaysyt_chestplate;
	public static Item ianplaysyt_leggings;
	public static Item ianplaysyt_boots;
	
	public static Item bossface88_sword;
	public static Item bossface88_pickaxe;
	public static Item bossface88_axe;
	public static Item bossface88_shovel;
	public static Item bossface88_hoe;
	public static Item bossface88_helmet;
	public static Item bossface88_chestplate;
	public static Item bossface88_leggings;
	public static Item bossface88_boots;

	public static Item diamondtips_sword;
	public static Item diamondtips_pickaxe;
	public static Item diamondtips_axe;
	public static Item diamondtips_shovel;
	public static Item diamondtips_hoe;
	public static Item diamondtips_helmet;
	public static Item diamondtips_chestplate;
	public static Item diamondtips_leggings;
	public static Item diamondtips_boots;
	...
	public static void init() {
		...
		ianplaysyt_chestplate = new ianplaysyt_armor(ianplaysyt_armor_material, 0, EntityEquipmentSlot.CHEST).setCreativeTab(Main.TeamMadnessModArmorTab);
		ianplaysyt_leggings = new ianplaysyt_armor(ianplaysyt_armor_material, 0, EntityEquipmentSlot.LEGS).setCreativeTab(Main.TeamMadnessModArmorTab);
		ianplaysyt_boots = new ianplaysyt_armor(ianplaysyt_armor_material, 0, EntityEquipmentSlot.FEET).setCreativeTab(Main.TeamMadnessModArmorTab);
		...
		bossface88_chestplate = new bossface88_armor(bossface88_armor_material, 0, EntityEquipmentSlot.CHEST).setCreativeTab(Main.TeamMadnessModArmorTab);
		bossface88_leggings = new bossface88_armor(bossface88_armor_material, 0, EntityEquipmentSlot.LEGS).setCreativeTab(Main.TeamMadnessModArmorTab);
		bossface88_boots = new bossface88_armor(bossface88_armor_material, 0, EntityEquipmentSlot.FEET).setCreativeTab(Main.TeamMadnessModArmorTab);
		...
		diamondtips_chestplate = new diamondtips_armor(diamondtips_armor_material, 0, EntityEquipmentSlot.CHEST).setCreativeTab(Main.TeamMadnessModArmorTab);
		diamondtips_leggings = new diamondtips_armor(diamondtips_armor_material, 0, EntityEquipmentSlot.LEGS).setCreativeTab(Main.TeamMadnessModArmorTab);
		diamondtips_boots = new diamondtips_armor(diamondtips_armor_material, 0, EntityEquipmentSlot.FEET).setCreativeTab(Main.TeamMadnessModArmorTab);
	...
	public static void registry() {
		...
		GameRegistry.register(ianplaysyt_axe);
		GameRegistry.register(ianplaysyt_shovel);
		GameRegistry.register(ianplaysyt_hoe);
		GameRegistry.register(ianplaysyt_helmet);
		GameRegistry.register(ianplaysyt_chestplate);
		GameRegistry.register(ianplaysyt_leggings);
		GameRegistry.register(ianplaysyt_boots);

		GameRegistry.register(bossface88_sword);
		GameRegistry.register(bossface88_pickaxe);
		GameRegistry.register(bossface88_axe);
		GameRegistry.register(bossface88_shovel);
		GameRegistry.register(bossface88_hoe);
		GameRegistry.register(bossface88_helmet);
		GameRegistry.register(bossface88_chestplate);
		GameRegistry.register(bossface88_leggings);
		GameRegistry.register(bossface88_boots);

		GameRegistry.register(diamondtips_sword);
		GameRegistry.register(diamondtips_pickaxe);
		GameRegistry.register(diamondtips_axe);
		GameRegistry.register(diamondtips_shovel);
		GameRegistry.register(diamondtips_hoe);
		GameRegistry.register(diamondtips_helmet);
		GameRegistry.register(diamondtips_chestplate);
		GameRegistry.register(diamondtips_leggings);
		GameRegistry.register(diamondtips_boots);
	...
	public static void registerRenders() {
		...
		registerRender(ianplaysyt_axe);
		registerRender(ianplaysyt_shovel);
		registerRender(ianplaysyt_hoe);
		registerRender(ianplaysyt_helmet);
		registerRender(ianplaysyt_chestplate);
		registerRender(ianplaysyt_leggings);
		registerRender(ianplaysyt_boots);

		registerRender(bossface88_sword);
		registerRender(bossface88_pickaxe);
		registerRender(bossface88_axe);
		registerRender(bossface88_shovel);
		registerRender(bossface88_hoe);
		registerRender(bossface88_helmet);
		registerRender(bossface88_chestplate);
		registerRender(bossface88_leggings);
		registerRender(bossface88_boots);

		registerRender(diamondtips_sword);
		registerRender(diamondtips_pickaxe);
		registerRender(diamondtips_axe);
		registerRender(diamondtips_shovel);
		registerRender(diamondtips_hoe);
		registerRender(diamondtips_helmet);
		registerRender(diamondtips_chestplate);
		registerRender(diamondtips_leggings);
		registerRender(diamondtips_boots);
